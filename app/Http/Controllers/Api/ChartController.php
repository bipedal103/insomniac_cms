...
class ChartController extends Controller
{
	...
	{
		$user = $request->user();
		$min_date = formatTimestamp($request->min_date, 'Y-m-d H:i', 'Y-m-d H:i', $user->timezone);
		$max_date = formatTimestamp($request->max_date, 'Y-m-d H:i', 'Y-m-d H:i', $user->timezone);
