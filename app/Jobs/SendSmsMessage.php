...
class SendSmsMessage implements ShouldQueue
{
	...
	private function sendSmsVonage(): ?Collection
	{
	...
	private function sendSmsTwilio(): ?MessageInstance
	{
	...
	private function sendSmsInfoBip(): ?array
	{
	...
	private function sendSmsNth(): ?array
	{
		$nth = new NthHandler;
	...
	private function sendSmsElks(): ?array
	{
