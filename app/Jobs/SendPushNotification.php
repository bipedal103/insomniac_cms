...
class SendPushNotification implements ShouldQueue
{
	...
	private function sendExpo(): ?array
	{
	...
	private function sendOneSignal(): ?array
	{
		...
		if ($this->notification->radius) {
			$filters[] = ['field' => 'location', 'radius' => $this->notification->radius, 'lat' => $this->notification->location_lat, 'lng' => $this->notification->location_lng];
		}
