			...
			<div class="tab-pane fade" id="btabs-location" role="tabpanel">
				...
				@if($notification->radius)
					<div class="form-group">
						...
						<iframe class="map-area" frameborder="0" allowfullscreen src="https://google.com/maps/embed/v1/place?q={{ $notification->location_lat }},{{ $notification->location_lng }}&zoom=10&key={{ setting('google_api_key') }}"></iframe>
					</div>
				@endif
			</div>
