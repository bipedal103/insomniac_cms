...
$fields_security = [
	...
	[
		...
		'tag' => 'textarea',
		'value' => $settings->csp_allowed_scripts,
		'attributes' => [
	...
	[
		...
		'tag' => 'textarea',
		'value' => $settings->csp_allowed_styles,
		'attributes' => [
...
$fields_media = [
	...
	[
		...
		'tag' => 'textarea',
		'value' => $settings->responsive_images_breakpoints,
		'attributes' => [
...
$fields_spotify = [
	[
		'label' => __('settings.spotify-app-id'),
		'tag' => 'input',
		'attributes' => [
			'id' => 'spotify_app_id',
			'name' => 'spotify_app_id',
			'type' => 'text',
			'value' => $settings->spotify_app_id,
			'maxlength' => 128,
			'required' => true,
		]
	],
	[
		'label' => __('settings.spotify-app-secret-key'),
		'tag' => 'input',
		'attributes' => [
			'id' => 'spotify_app_secret',
			'name' => 'spotify_app_secret',
			'type' => 'text',
			'value' => $settings->spotify_app_secret,
			'maxlength' => 128,
			'required' => true,
		]
	],
	[
		'label' => __('settings.spotify-redirect-url'),
		'tag' => 'input',
		'attributes' => [
			'id' => 'spotify_redirect_url',
			'name' => 'spotify_redirect_url',
			'type' => 'url',
			'value' => $settings->spotify_redirect_url,
			'maxlength' => 1000
		]
	],
	[
		'label' => __('settings.spotify-perms'),
		'tag' => 'input',
		'attributes' => [
			'id' => 'spotify_perms',
			'name' => 'spotify_perms',
			'type' => 'text',
			'value' => $settings->spotify_perms,
			'maxlength' => 450,
		],
		'message' => __('settings.available-spotify-perms')
	],
	[
		'label' => __('settings.spotify-connect-url'),
		'tag' => 'input',
		'attributes' => [
			'id' => 'spotify_connect_url',
			'name' => 'spotify_connect_url',
			'type' => 'url',
			'value' => $settings->spotify_connect_url,
			'maxlength' => 1000,
		]
	],
];
...
@section('content')
	@include('layouts.single_header', ['title' => __('settings.general.title'), 'icon' => 'fa fa-cogs', 'save_and_return' => false, 'updated_at' => $settings->updated_at])
	<form class="form form-notify" action="{{ route('settings.general.update', $settings->id) }}" method="post" autocomplete="off" id="main-form">
		@csrf
		<div class="card-body">
			<div class="row">
				<div class="col-3">
					<ul class="nav nav-pills flex-column" role="tablist" data-active-tab="tab">
						...
						<li class="nav-item">
							<a href="#btabs-spotify" class="nav-link" data-toggle="tab">
								<span class="nav-icon"><i class="fab fa-spotify"></i></span>
				...
				<div class="col-9">
					<div class="tab-content">
						...
						<div class="tab-pane fade" id="btabs-spotify" role="tabpanel">
							@include('layouts.forms.generate_form_fields', ['fields' => $fields_spotify])
						</div>
